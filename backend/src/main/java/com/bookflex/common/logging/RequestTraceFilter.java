...
public class RequestTraceFilter extends OncePerRequestFilter {
    ...
    public static final String USER_ID_ATTRIBUTE = "bookflex.currentUserId";
    ...
    private static final Logger accessLog = LoggerFactory.getLogger("com.bookflex.log.ACCESS");
