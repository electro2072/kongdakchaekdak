...
public class InvalidCredentialsException extends RuntimeException implements CodedException {
    ...
    /**
     * @deprecated 세부 코드를 지정하는 {@link #InvalidCredentialsException(ErrorCode, String)}를 쓸 것.
     *             이 생성자는 기존 호출부의 점진 이관을 위해 한시적으로 남겨둔 것이며,
     *             {@link ErrorCode#INVALID_CREDENTIALS}으로 폴백한다.
     */
    @Deprecated
    public InvalidCredentialsException(String message) {
        this(ErrorCode.INVALID_CREDENTIALS, message);
    }
